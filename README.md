# Windows11Long_Alexa💥 <img width="24" height="24" alt="image" src="https://github.com/user-attachments/assets/03b4c56f-2794-46f5-a494-77ddc5a623bf" />
...
## 📢 Mi ez?
A <tt>Win11Long_Alexa</tt> és <tt>Tiny11_25_Alexa*</tt> a Microsoft Windows 11 Enterprise[^2] LTSC 2024<sup>(*2025)</sup>  felhasználásával készült **eredeti Windows telepítő** <sup>(kizárólag a Microsoft által is ismert optimalizáló rendszerelemeket, illetve a rendszer integritásra és rendszer biztonságra semmilyen káros hatással nem bíró módosításokat tartalmaz)</sup>. 
Gyorsabb, stabilabb, mint általában a Windows. Sallang mentes, de minden előnyt élvez, amit egy Windows rendszer tudhat. Nem zaklat állandó "fícsör" vagy funkció frissítéssel, ami sokszor destabilizálja kiadásakor a rendszert, a javítások végeláthatatlan során meg bosszankodik a felhasználó. 
...
🏆**A valaha volt (talán) legjobb magyar tiszta telepítő**" Plusz szolgáltatások: optimalizálva van az iso-ban az .Alexa mappa kezelése (ez egy rövid, közérthető leírás mellett számos jobbnál jobb lehetőséget biztosít a személyre szabásra), több lemezes/partíciós gépen is meglesz. Automatikusan települhet: Chrome böngésző, VLC zene/videólejátszó, XnView képnézegető/szerkesztő, persze törölhetők is...

 <hr>

 📀egy régebbi változat: <a href="https://mega.nz/file/1IRyhIjb#yxWI9-Kp8kTr20mcY-SOENL4KkLg6_sSioQc-Q5f4e8" target="_blank">Win11Long_Alexa.iso</a> (<sup>😷 iso eredetiség ellenőrző összeg:  <tt>322E77E35F3A6C3C8CA7FBD20E9424DB53A5DB54D6920E38BC7AC1F8CA4AC965</tt></sup>)

📀<a href="https://mega.nz/file/0RJV0KqS#MCCDTS65tMoSb6BrE1k3K287LZWg77Jo6a2BUr6IDDo" target="_blank">Tiny11_25_Alexa.iso</a>
<sup>**🤞Új Extra! 😉Kakukktojás! A Windows 11 25H2** "tiny" (kicsi) változata, az eredeti MS 7 GB helyett 5GB telepítő; ez is minden felesleges sallangtól megtisztítva, de anélkül, hogy az élvezeti értéke, használhatósága sérült volna...A Microsoft hardverkövetelményei is kizárva, és "long", várhatóan 2035-ig támogatott a MS által! A Long_Alexa2 szerinti '.Alexa' mappa kezelés és 3 automatikus program telepítés: Chrome, VLC, Xnview itt is lefuthat... viszont eleve nincs Edge böngésző;) </sup>)
...
> [!NOTE]
> 👌👌👌<sup>Nincs USB adathordozód? Vagy nem akarod törölni a tartalmát? Sebaj: olvasd el <a href="https://github.com/mondomata/Windows-Simplegood">ezt az írást</a></sup>
...
(3) A Rufusban válaszd ki az USB tárolód (eszköz), majd tallózd be a letöltött ISO fájlt (Boot kiválasztás). Más beállításon ne módosíts (a Rufus automatikusan beállítja az egyéb paramétereket). Az INDÍTÁS gombbal indítsd el az ISO kiírását az USB-re (a felugró/figyelmeztető ablakokban Ok-t nyomj, néhány perc az írás, és KÉSZ).

<img width="250" height="266" alt="rufus" src="https://github.com/user-attachments/assets/15acb3b9-5613-4fdd-b6ba-dc0690f6befb" />


## 🛠️Telepítés
⚠️ telepítés megkezdés előtt mentsd amit muszáj, mert mindent is töröl a telepítő a lemezről ⚠️
...
- 😜❌Telepítő online kapcsolat követelése. Ha akarod, van lehetőség internet kapcsolattal telepíteni.<sup>de így tapasztalat szerint nem kívánt MS összetevőket is kapsz</sup>
