...
*<b>🥇USB tároló/"pendrájv" nélküli telepítés</b>* közben felülírható a meglévő Windows így ("tiszta" telepítés!): készíts a Windows Partíciókezelővel egy új, kb. 10GB-os  FAT partíciót a lemezeden, adj neki betűjelet (pl. W).  Csatold a fájlkezelőn a nevére kattintva a telepítő ISO-t (D: , vagy G: vagy hasonló meghajtón fog megnyílni), abból másold az összes mappát és fájlt az új, előbb adott betűjelű (pl.W:) partícióra. Windows Helyreállítási Módban (ezt <kbd>Shift</kbd>-et nyomva tartva a Start menüben az *Újraindítás*-ra kattintva is el lehet érni), majd az újraindulás után megjelenő spec. menüben válaszd a *Hibaelhárítás -> Speciális lehetőségek -> Parancssor* lehetőséget. Gépeld be: <tt>C:\setup</tt> és [Enter]-rel indíthatod a Windows telepítőt. A telepítőben a meglévő Windows partíciót választva a régi Windowst az új Windows felülírja (<i>mindent töröl!!!</i>). Ha hibát jelez a Parancssor (nem indul a telepítő), egyszerűen ismételd meg a parancs kiadását így: <tt>D:\setup</tt> <kbd>[Enter]</kbd> vagy <tt>E:\setup</tt> <kbd>[Enter]</kbd>, stb. (abc betűivel) amíg rátalálva a helyes betűjelre elindul a telepítő.
<hr>
