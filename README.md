...
## 📢 Mi ez?
A <tt>Win11Long_Alexa</tt> és <tt>Tiny11_25_Alexa*</tt> a Microsoft Windows 11 Enterprise[^2] LTSC 2024<sup>(*2025)</sup>  felhasználásával készült **eredeti Windows telepítő**<sup>(a forráskód érintetlen, kizárólag a Microsoft által is ismert módszerekkel optimalizált rendszer elemekkel)</sup>! Gyorsabb, stabilabb, mint általában a Windows. Sallang mentes, de minden előnyt élvez, amit egy Windows rendszer tudhat. Nem zaklat állandó "fícsör" vagy funkció frissítéssel, ami sokszor destabilizálja kiadásakor a rendszert, a javítások végeláthatatlan során meg bosszankodik a felhasználó! 
...
(1) Töltsd le a kiválasztott <tt><b>.iso</b></tt>-t, majd <a href="https://github.com/pbatard/rufus/releases/download/v3.16/rufus-3.16p.exe">➡ezt a Rufust</a>.
